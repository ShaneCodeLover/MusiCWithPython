...
class Hell_Yeah(tk.Frame):
    def __init__(self, master=None):
        ...
        # using pickle file
        if os.path.exists('C:\\Users\\hp\\Desktop\\MUSIC\\songs.pickle'):
            with open('C:\\Users\\hp\\Desktop\\MUSIC\\songs.pickle', 'rb') as f:
    ...
    def create_frames(self):
        ...
        self.track.config(height=300, width=450)
        ...
        self.tracklist.grid(row=0, column=1, padx=0, pady=10, rowspan=2)

        # Frames for control menu:  here all required controls and progressbar will be there
        self.controls= tk.LabelFrame(self, font=("times new roman" , 15, 'italic'), bd=2, fg='white', bg='purple', relief=tk.GROOVE)
        self.controls.config(height=80, width=470)
        self.controls.grid(row=1, column=0, padx=10, pady=5)
    ...
    def  track_widgets(self):
        ...
        self.songtrack = tk.Label(self.track, font=("times new roman", 13, "italic"), bg="white", fg="dark blue", text="Advanced Music player",compound='left', anchor="w")
    ...
    def control_widgets(self):
        ...
        self.loadSongs = tk.Button(self.controls, bg='blue', fg='white', font=('consolas',12,'italic'), text="Load-Song", command=self.retreive_songs)
        self.loadSongs.grid(row=0, column=0, padx=10)

        # setting the loop button as per Button orderss
        self.loop = tk.Button(self.controls, image=loop, command=self.loops2)
        self.loop.grid(row=0, column=1)

        # Previous Button: playing the previous song
        self.previous = tk.Button(self.controls, image=prev, command=self.prev_song)
        self.previous.grid(row=0, column=2)

        # For playing the songs
        # Main function
        self.play = tk.Button(self.controls, image=play, command=self.pause_song)
        self.play.grid(row=0, column=3)
        

        # For next songs: i.e for playing the next song
        self.next_ = tk.Button(self.controls, image=next_, command=self.next_song)
        self.next_.grid(row=0, column=4)

        # Shuffle or playall Buttons: For playing all songs in ascending order
        self.shuffle = tk.Button(self.controls, image=shuffle, command=self.playall)
        ...
        self.slider = ttk.Scale(self.controls, from_=0, to = 10, orient=tk.HORIZONTAL, variable=self.volume, command=self.change_volume)
        self.slider.set(8)
        self.slider.grid(row=0, column=6, padx=2)
        
        # progressbar: showing how much song been played
        self.progress_bar = Progressbar(self.controls, style="red.Horizontal.TProgressbar", mode='determinate', orient=tk.HORIZONTAL, length=410)
    ...
    def tracklist_widget(self):
        ...
        self.list = tk.Listbox(self.tracklist, bg='grey', fg='blue', font=('times new roman', 10, "italic"), selectmode=tk.SINGLE, yscrollcommand=self.scrollbar.set, selectbackground='sky blue')
    ...
    def retreive_songs(self):
        ...
        with open('C:\\Users\\hp\\Desktop\\MUSIC\\songs.pickle', 'wb') as f:
    ...
    def song(self, event=None):
        ...
        self.canvas.grid(row=0,column=0, columnspan=2)
        if self.paused == False:
            self.l = AnimatedGIF(self.canvas, "C:\\Users\\hp\\Desktop\\MUSIC\\12.gif")
            self.l.pack()
        else:
            self.canvas['image'] = img
...
root.iconbitmap('C:\\Users\\hp\\Desktop\\MUSIC\\M.ico')
root.resizable(0,0)

# Here import the PIL pip install pillow
from PIL import ImageTk, Image

image = Image.open('C:\\Users\\hp\\Desktop\\MUSIC\\music.jpg')
image = image.resize((450, 300), Image.ANTIALIAS)
img = ImageTk.PhotoImage(image)
pause = PhotoImage(file='C:\\Users\\hp\\Desktop\\MUSIC\\pause.png')
prev = PhotoImage(file='C:\\Users\\hp\\Desktop\\MUSIC\\previous.png')
play = PhotoImage(file='C:\\Users\\hp\\Desktop\\MUSIC\\play.png')
shuffle = PhotoImage(file='C:\\Users\\hp\\Desktop\\MUSIC\\shuffle.png')
next_ = PhotoImage(file='C:\\Users\\hp\\Desktop\\MUSIC\\next.png')
loop = PhotoImage(file='C:\\Users\\hp\\Desktop\\MUSIC\\Loop.png')
